...
__str = "11573980.55,3568447.03,11574101.0,3568446.52,11574118.48,3568538.47,11574185.05,3568541.04," \
        "11574192.12,3568384.89,11574194.82,3568359.98,11574197.21,3568339.04,11574197.49,3568319.26," \
        "11574198.19,3568285.16,11574198.71,3568247.51,11574199.51,3568195.02,11574198.07,3568182.52," \
        "11574135.51,3568184.06,11574031.09,3568182.52,11573976.1,3568183.03,11573976.35,3568251.22," \
        "11573974.85,3568337.76,11573975.15,3568408.2,11573980.55,3568447.03"
__list = __str.split(",")
print("__list: %s" % __list)
__m = 0
__n = 1
__geo = []
while __n <= len(__list):
    __str1 = __list[__m] + ',' + __list[__n]
    __geo.append(__str1)
    __m = __m + 2
    __n = __n + 2
print("__geo: %s" % __geo)
